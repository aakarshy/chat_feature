...
const EditProfile = () => {
  ...
  const [nameHover, setUsernameHover] = useState(false);
  ...
  const animation1Props = useSpring({
    opacity: 1,
    marginLeft: 0,
    background: nameHover ? '#eee' : 'rgb(210, 210, 210)',
    transform: nameHover ? 'translateY(-5px)' : 'translateY(0px)',
    boxShadow: nameHover ? '1rem 1rem 1rem #222' : '0rem 0rem 0rem #222',
            ...
            >
              <div className='editprofileformcontainer'>
                <div className='editprofile-button'>
                  {/* {nameHover ? 'edit name' : userInfo.name} */}
                  edit name
                </div>
              </div>
            </animated.div>
